...
const stations: StepperStationView[] = [
  { key: 'escuta1', label: 'Ouvir', state: 'done', reachable: true },
  { key: 'triagem', label: 'Triagem', state: 'current', reachable: true },
  { key: 'segmentacao', label: 'Frases', state: 'future', reachable: false },
];
