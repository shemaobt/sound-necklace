...
- The EN interview translations ship **pending human review** (flagged in @/ui/i18n/conversation-questions.ts). They are display-only, so a wording change there cannot affect an artifact.
