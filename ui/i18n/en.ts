...
export const en: Dict = {
  ...
  projectSettings: {
    eyebrow: 'Project',
    title: 'Bead size',
    lead: "The bead size applies to the whole project: every audio is cut on the same grid. That is what keeps a project's material on one coordinate system.",
    levelsAria: "The project's bead size",
    save: 'Save',
    saving: 'Saving…',
    saved: 'Bead size saved.',
    loading: 'Loading…',
    readError: "Could not read the project's settings. Reload the page.",
    saveError: 'Could not save. Try again.',
    forbidden: 'Only a project admin can change the bead size.',
    lockedTitle: 'Already set',
    lockedBody:
      'This project has already cut audio on this grid, so the bead size no longer changes. Re-cutting it would change the reference of everything already exported.',
    unset: 'Nobody has set it yet.',
    back: '← Back',
  },
  setup: {
    eyebrow: 'Preparation',
