...
export const en: Dict = {
  ...
  coverageDrawer: {
    ...
    overviewScenes: 'Scenes',
    overviewScenesSub: '{{named}} with a kind · {{none}} outside the kinds',
    overviewPhrases: 'Phrases',
    overviewPhrasesAll: 'every scene has phrases',
    overviewPhrasesSome_one: '{{count}} scene without phrases',
    overviewPhrasesSome_other: '{{count}} scenes without phrases',
    overviewDuration: 'Duration',
    overviewDurationCaption: 'beads of {{seconds}}s',
    overviewConfidence: 'Confidence',
    overviewConfidenceLine: 'Certain {{high}} · Almost {{medium}} · In doubt {{low}}',
    sceneByScene: 'Scene by scene',
    byKind: 'Count by kind',
    sceneNoneFit: 'none fit',
    scenePhraseCount_one: '{{count}} phrase',
    scenePhraseCount_other: '{{count}} phrases',
