...
export const pt = {
  ...
  coverageDrawer: {
    ...
    /* ENG-726 — o resumo da história inteira, só na Rever (storyOverview). */
    overviewScenes: 'Cenas',
    overviewScenesSub: '{{named}} com tipo · {{none}} fora dos tipos',
    overviewPhrases: 'Frases',
    overviewPhrasesAll: 'todas as cenas com frases',
    overviewPhrasesSome_one: '{{count}} cena sem frases',
    overviewPhrasesSome_other: '{{count}} cenas sem frases',
    overviewDuration: 'Duração',
    overviewDurationCaption: 'contas de {{seconds}} s',
    overviewConfidence: 'Confiança',
    overviewConfidenceLine: 'Certeza {{high}} · Quase {{medium}} · Na dúvida {{low}}',
    sceneByScene: 'Cena a cena',
    byKind: 'Contagem por tipo',
    sceneNoneFit: 'nenhum se encaixa',
    scenePhraseCount_one: '{{count}} frase',
    scenePhraseCount_other: '{{count}} frases',
    sceneMeta: '{{duration}} · {{phrases}}',
  },
  seamModal: {
