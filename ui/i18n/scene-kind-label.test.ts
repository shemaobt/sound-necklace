...
/**
 * Rótulo de `scene_kind` por idioma (ENG-279). O VALOR inglês é o que fica armazenado
 * e nunca muda — só o rótulo EXIBIDO acompanha a UI. O `domain/` fica intocado: PT vem
 * do `skShort` e EN do `skEnShort`.
 */
