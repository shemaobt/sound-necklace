...
- The human figure that guides the listener through the Conversation conversation (PRD §6.6, §8.7): it must read as a **real, warm person** — looking at you, breathing, blinking, and moving its mouth while the question is spoken. Explicitly not abstract, not geometric.
