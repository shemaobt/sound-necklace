...
/**
 * O transporte da Escuta 1 espelha o §8.2 (o colar é o transporte): tocar numa
 * conta toca a partir dela, e tocar a cabeça brilhante pausa/retoma. Dirigido com
 * áudio de fixture (relógio falso), afirmado pela saída observável (head emitido,
 * player.state) — nunca por dentro.
 */
