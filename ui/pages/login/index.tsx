  ...
  return (
    ...
    <main className="cds-login">
      <aside className="cds-login-hero">
        ...
        <p className="cds-login-tagline">
          Cada história contada em voz alta vira um colar de contas — ouvida, cortada e guardada
          aqui, com vocês.
        </p>
        <p className="cds-login-privacy">
          ...
          Nada do áudio sai deste computador.
        </p>
      </aside>

      <form className="cds-login-card" onSubmit={onSubmit}>
        <div className="cds-login-head">
          <p className="cds-login-eyebrow">Entrar</p>
          <h1 className="cds-login-title">Bem-vinda de volta.</h1>
          <p className="cds-login-subtitle">Continue de onde vocês pararam.</p>
        </div>
